            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: active
                      ? const [
                          BoxShadow(color: Color(0x339d4edd), blurRadius: 8)
                        ]
                      : null,
                ),
                child: Icon(
      ...
      children: [
        const Text('Notes',
            style: TextStyle(
                ...
                fontSize: 16)),
        const SizedBox(height: 4),
        const Text('Optional — add any thoughts or context',
            style: TextStyle(color: Color(0x66FFFFFF), fontSize: 12)),
        const SizedBox(height: 12),
        ...
        Container(
          ...
          child: Theme(
            ...
            child: TextField(
              ...
              maxLines: 4,
              style: const TextStyle(
                  color: Color(0xE6FFFFFF), fontSize: 14, height: 1.5),
                ...
                Row(
                    children: List.generate(
                        ...
                        (_) => const Icon(Icons.star_rounded,
                            color: Color(0xFF9d4edd), size: 12))),
