...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> _handleLogin() async {
    ...
    // }
    _snack('Backend login temporarily disabled', Colors.orange);
  }
  ...
  Future<void> _handleSignup() async {
    ...
    //   setState(() => _isAuthLoading = false);
    // }
    _snack('Backend registration temporarily disabled', Colors.orange);
  }
  ...
  Future<void> _handleLogout() async {
    ...
    // }
    _snack('Backend logout temporarily disabled', Colors.orange);
  }
              ...
              children: [
                _actionTile(
                  ...
                  () async {
                    ...
                    if (mounted) {
                      context.go(
                          '/main'); // Changed from /dashboard to /main (home page with teacher)
                      _snack(
