...
class AppSettingsProvider with ChangeNotifier {
  ...
  Future<void> _loadSettings() async {
    ...
    if (savedLanguage is String) {
      try {
        _language =
            AppLanguage.values.firstWhere((e) => e.code == savedLanguage);
      } catch (_) {}
    }

    // Load voice personality
    final savedPersonality =
        LocalStorageService.getSetting('voice_personality');
  ...
  Future<void> setVoicePersonality(VoicePersonality personality) async {
    ...
    await LocalStorageService.saveSetting(
        'voice_personality', personality.name);
  ...
  Future<void> resetToDefaults() async {
    ...
    await LocalStorageService.saveSetting(
        'voice_personality', _voicePersonality.name);
