...
void main() {
  group('Wallet System Tests', () {
    ...
    test('Convert tokens to coins', () async {
      ...
      expect(success, isTrue);
      expect(walletService.mindfulnessTokensBalance, equals(initialTokens - tokensToConvert));
      expect(walletService.coinsBalance, equals(initialCoins + (tokensToConvert * 10)));
    });
